...
import { bulkImportOutreachContacts } from '@/lib/db/queries/outreach-contacts-bulk';
...
export async function POST(req: NextRequest) {
  try {
    ...
    const result = await bulkImportOutreachContacts(session.orgId, rows, continueOnError !== false);
