...
import { bulkImportEmailTemplates } from '@/lib/db/queries/email-templates-bulk';
...
export async function POST(req: NextRequest) {
  try {
    ...
    const result = await bulkImportEmailTemplates(session.orgId, rows, continueOnError !== false);
