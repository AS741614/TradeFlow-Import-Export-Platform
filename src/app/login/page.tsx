  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '80vh' }}>
      <div className="card" style={{ width: '400px', padding: 'var(--space-xl)' }}>
        <h2 style={{ textAlign: 'center', marginBottom: 'var(--space-md)' }}>Sign In to TradeFlow</h2>
        ...
        <form onSubmit={handleCredentialsLogin} style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-md)' }}>
          <div>
          ...
          <button id="btn-login-submit" type="submit" className="btn btn-primary" style={{ marginTop: 'var(--space-sm)' }} disabled={isPending}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', margin: 'var(--space-lg) 0' }}>
          ...
          <span style={{ padding: '0 var(--space-sm)', fontSize: 'var(--font-size-xs)', color: 'var(--text-tertiary)' }}>or</span>
          <div style={{ flex: 1, height: '1px', background: 'var(--border-subtle)' }} />
        </div>

        <button id="btn-login-google" onClick={handleGoogleLogin} className="btn btn-secondary" style={{ width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 'var(--space-sm)' }}>
